...
struct StandChartView: View {
    ...
    func createLegend() -> some View {
        ...
        return HStack(alignment: .center) {
            ...
            self.createLegendTime("00:00")
            Spacer()
            self.createLegendTime("04:00")
            Spacer()
            self.createLegendTime("08:00")
            Spacer()
            self.createLegendTime("12:00")
            
        }
    }
    func createLegendTime(_ time: String) -> some View {
