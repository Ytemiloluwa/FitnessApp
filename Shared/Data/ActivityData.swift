...
struct ActivityData  {
    ...
    static let weekdays: [(firstLetter: String, movePercentage: Double, exercisePercentage: Double, standPercentage:
                            Double)] = [
                                        (firstLetter: "M", movePercentage: 1.2, exercisePercentage: 1.3, standPercentage: 1.2),
                                        (firstLetter: "T", movePercentage: 1.5, exercisePercentage: 0.4, standPercentage: 1.5),
                                        ...
                                        (firstLetter: "S", movePercentage: 0.8, exercisePercentage: 1.1, standPercentage: 1.8),
                                        (firstLetter: "S", movePercentage: 0.5 ,  exercisePercentage: 0.8, standPercentage: 0.7)
                                       ]
